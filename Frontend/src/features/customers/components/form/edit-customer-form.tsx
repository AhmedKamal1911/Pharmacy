...
interface EditCustomerFormProps {
  ...
  initialData?: Partial<EditCustomerFormData>;
  isLoading?: boolean;
}
    ...
    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
      <FieldGroup>
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="edit-customer-name">اسم العميل</FieldLabel>
              <Input
                {...field}
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="edit-customer-phone">رقم الهاتف</FieldLabel>
              <Input
                {...field}
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="edit-customer-address">العنوان</FieldLabel>
              <Input
                {...field}
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="edit-customer-type">نوع العميل</FieldLabel>
              <Select
                value={field.value}
        ...
        <Controller
          ...
          render={({ field }) => (
            <Field>
              <FieldLabel htmlFor="edit-customer-cash-only">
                الدفع نقداً فقط
              </FieldLabel>
              <Select
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={fieldState.invalid}>
              <FieldLabel htmlFor="edit-customer-credit-limit">
                حد الائتمان
              </FieldLabel>
              <Input
                {...field}
